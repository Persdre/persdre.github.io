...
Hello, talented young minds visiting my website! **I am recruiting undergraduate/graduate research interns to co-author publications for top conferences.** I have successfully led multiple papers that resulted in strong publications (one ICLR, one EMNLP, two papers are in submission). Your authorship position—either first or second author—will be determined by the level of your contribution. If interested, please reach out as soon as possible.
